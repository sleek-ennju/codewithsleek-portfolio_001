...
function loadPublishedProjects() {
  return getDb().project.findMany({ where: { status: "PUBLISHED" }, orderBy: [{ displayOrder: "asc" }, { publishedAt: "desc" }], include: { cardImage: true, technologies: { orderBy: { position: "asc" }, take: 4, include: { technology: true } } } });
}
