  ...
  return (
    <main className="admin-main">
      <div className="admin-page-heading">
        <div>
          <p className="admin-eyebrow">Portfolio operations</p>
          <h1>Dashboard</h1>
          <p>Publishing health, content readiness, and recent administration activity.</p>
        </div>
        ...
        <section className="admin-panel">
          ...
          {overview.recentActivity.length ? (
              ...
              {overview.recentActivity.map((item) => (
                <li key={item.id}>
                  ...
                  <time dateTime={item.createdAt.toISOString()}>
                    {item.createdAt.toLocaleDateString("en-NG", {
                      day: "numeric",
                      month: "short",
                      year: "numeric",
                    })}
            ...
            <div className="admin-empty-state">
              ...
              <p>Publishing and destructive actions will appear here.</p>
            </div>
          )}
        </section>
        <aside className="admin-panel admin-readiness">
          <p className="admin-eyebrow">Release readiness</p>
