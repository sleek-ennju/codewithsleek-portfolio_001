...
export default async function NewProjectPage() {
  ...
  return <main className="admin-main"><div className="admin-page-heading"><div><p className="admin-eyebrow">New project</p><h1>Create a case study</h1><p>Start as a draft, then publish when the public story is ready.</p></div><Link className="admin-secondary-button" href="/admin/projects">Return to projects</Link></div><div className="admin-panel"><ProjectForm action={createProject} media={media} technologyOptions={technologies} /></div></main>;
}
