...
function GitHubIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M12 .7a11.5 11.5 0 0 0-3.64 22.4c.58.1.79-.25.79-.56v-2.24c-3.22.7-3.9-1.37-3.9-1.37-.52-1.34-1.29-1.7-1.29-1.7-1.05-.72.08-.71.08-.71 1.17.08 1.78 1.2 1.78 1.2 1.04 1.78 2.72 1.27 3.38.97.1-.75.4-1.27.74-1.56-2.57-.29-5.27-1.28-5.27-5.68 0-1.26.45-2.28 1.19-3.09-.12-.29-.52-1.46.11-3.05 0 0 .97-.31 3.16 1.18a10.94 10.94 0 0 1 5.76 0c2.2-1.49 3.16-1.18 3.16-1.18.63 1.59.23 2.76.11 3.05.74.81 1.19 1.83 1.19 3.09 0 4.41-2.71 5.38-5.29 5.67.42.36.79 1.07.79 2.16v3.21c0 .31.21.67.8.56A11.5 11.5 0 0 0 12 .7Z"
      />
    </svg>
  );
}
...
export async function SiteFooter() {
  ...
  const socials = [
    {
      label: "GitHub",
      href: settings.githubUrl || "https://github.com/sleek-ennju",
      icon: <GitHubIcon />,
    },
    ...
    <footer className="site-footer">
      ...
      <div className="container">
        <div className="footer-invitation">
          ...
          <Link href="#contact">
            Let&apos;s make it clear, useful, <span>and beautifully built.</span>
            <i>
              <DiagonalArrow />
            </i>
          </Link>
        ...
        <div className="footer-grid">
          <div className="footer-identity">
            <Image
              ...
              alt={`${settings.brandName} — ${settings.tagline}`}
              width={1300}
              height={683}
              sizes="180px"
            />
          ...
          <div>
            ...
            <Link className="footer-pending" href={`mailto:${settings.contactEmail}`}>
          ...
          <div>
            ...
            {socials.length ? (
              ...
              <p className="footer-pending">GitHub profile coming soon.</p>
            )}
          </div>
          <p className="footer-copyright">
            © {new Date().getFullYear()} Code with Sleek
            <br />
            All rights reserved.
          </p>
        </div>
